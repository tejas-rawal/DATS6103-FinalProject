...
/*  analyze the 2019 YRBS dataset.                                                      */
/*                                                                                      */
/*  Change the file location specification from 'c:\SADC2019' to the location where you */
...
/*                                                                                      */
/*  Note: Run '2019 SADC Formats Program.sas' BEFORE you run                            */
/*  '2019 SADC SAS Input Program.sas' to create the 2019 SADC dataset.                  */
/****************************************************************************************/
